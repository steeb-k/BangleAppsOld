...
const lockIconDark = require("heatshrink").decompress(atob("jEYwUBqtX///6tVqtfBoP1AoN8AoM9AoPwAoMPCwPAn/8gfVCwP1AQVcBAIOBmtcCgIaBAoMNAoNwApn8h5BB+E/AYIAD4BWDgYFvHYoAFA="))
const lockIconLight = require("heatshrink").decompress(atob("jEYwUBqtUA4MVqtVqH//8FAoNDAoPBAoMPAoPwCwM/4ED/kVCwMFAQVTBAIOB4tTCgIaBAoPxAoNPApkD+BBBh/AKIs/HQIAB/gFvSZY"))
...
// Now that widgets/theme are loaded, we can draw
drawWatchFace();
